...
Public Class Register_Details
    ...
    Private Sub TextBox2_TextChanged(sender As Object, e As EventArgs) Handles TextBox2.TextChanged
        If Not Regex.Match(TextBox2.Text, "^[a-z ]*$", RegexOptions.IgnoreCase).Success Then
            MsgBox("Please enter your name.(Numbers and special characters are not allowed)", "Participant's Name")
            TextBox2.Clear()
            TextBox2.Focus()
        End If
    End Sub
    ...
    Private Sub TextBox3_TextChanged(sender As Object, e As EventArgs) Handles TextBox3.TextChanged
        If Not Regex.Match(TextBox3.Text, "^[a-z ]*$", RegexOptions.IgnoreCase).Success Then
            MsgBox("Please enter your name.(Numbers and special characters are not allowed)", "Department Name")
            TextBox3.Clear()
            TextBox3.Focus()
        End If
    End Sub
    ...
    Private Sub TextBox4_TextChanged(sender As Object, e As EventArgs) Handles TextBox4.TextChanged
        If Not Regex.Match(TextBox4.Text, "^[a-z ]*$", RegexOptions.IgnoreCase).Success Then
            MsgBox("Please enter your name.(Numbers and special characters are not allowed)", "College Name")
            TextBox4.Clear()
            TextBox4.Focus()
        End If
    End Sub
    ...
    Private Sub cno_TextChanged(sender As Object, e As EventArgs) Handles TextBox5.TextChanged
        If Not Regex.Match(TextBox5.Text, "^[0-9]{1,10}$").Success Then
            MsgBox("Please enter your valid contact number.", "Participant's Contact Number")
            TextBox5.Clear()
            TextBox5.Focus()
        End If
    End Sub
